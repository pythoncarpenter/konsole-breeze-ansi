...
function M.apply()
  ...
  set("@variable.parameter", { fg = "#CDD6F4" })
  set("@parameter", { fg = "#CDD6F4" })
  set("@parameter.reference", { fg = "#CDD6F4" })
  ...
  set("@lsp.type.variable", { fg = "#EBA0AC" })
  set("@lsp.type.parameter.python", { fg = "#CDD6F4" })
  set("@lsp.type.variable.python", { fg = "#EBA0AC" })
